  ...
  return (
    <div className="lg:relative bg-[#EDFCE987]">
      ...
      <div className=" lg:pb-10 lg:mx-20">
        <div className="p-20 max-sm:flex max-sm:flex-col  max-sm:p-5 grid max-sm:grid-cols-1 max-xl:grid max-xl:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-10 items-center">
          <div>
