...
function AboutUs() {
  return (
    <div id="about-us" className="lg:relative">
      ...
      <div className="flex flex-row max-sm:flex-col justify-center gap-10  lg:mx-28 items-center">
        <img
          src={globalMapIcon}
          alt="globalMapIcon"
        ...
        <div className="text-[#565656]  text-lg mr-20 max-sm:mr-0 w-[500px] max-sm:w-10/12">
          ...
          <p className="py-2">
            Our mission is to provide a platform that is easy for business to go
            paperless and easy for clients, patients and employees to complete
            on all size mobile device anytime anywhere.
          </p>
          <p className="py-1">
            Our goal is reduce carbon footprint one piece of paper at a time,
            one company at a time for a greener safer world for the next
            generation.  
          </p>
        </div>
      </div>
      <div className="absolute right-0 -bottom-10 max-lg:hidden">
        <img
